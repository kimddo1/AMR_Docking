...
def parse_args():
    p = argparse.ArgumentParser(description="Make plots from phase4 CSVs")
    p.add_argument("--ablation_csv", type=str, default="outputs/phase4_ablation.csv")
    p.add_argument("--safety_csv", type=str, default="outputs/phase4_safety.csv")
    p.add_argument("--out_ablation", type=str, default="outputs/phase4_ablation_plots.png")
    p.add_argument("--out_safety", type=str, default="outputs/phase4_safety_plots.png")
    return p.parse_args()
...
def plot_ablation(rows, out_path):
    ...
    fig.suptitle("Phase 4 Ablation Summary")
    fig.tight_layout()
